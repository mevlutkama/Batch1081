...
public class StringManipulations01 {
    public static void main(String[] args) {
        // 1.Example: Print the first and the last the character of the given String on the console. "Java is easy"==>Jy
        ...
        System.out.println(firstChar + lastChar);//Note: If you use "char" data type in a math operation, Java uses ASCII values
        //not the characters
        System.out.println("" + firstChar + lastChar);//Note:When you put "" at the beginning it will be concatenation operation,
        //you will get String.

        //2.Way: By using substring()
        String firstCharacter = str.substring(0, 1);//substring (0,1) gives you first character everytime
        String lastCharacter = str.substring(str.length() - 1);//substring (beginning index) gives you the characters from a
        //spesific index to the last index
        ...
        //3.Example: Type code to get initials of the first name and the last name of a given name. Ali Can ==> AC, Mary Star ==> MS
        ...
        //Note: If you use "length" after split() method do not use parenthesis, when you use it for Strings put parenthesis
        //after the length.
