...
public class TreeMap01 {
    ...
    public static void main(String[] args) {
        ...
        // If the "key" inside the ceilingEntry() method parenthesis is before any key, it returrns the next entry.
        ...
        // lowerEntry("Germany") method gives the previous entry under every condition but floorEntry("Germany") method gives the same entry
        ...
        NavigableMap<String, Integer> tailMap2 = countryPopulations.tailMap("Turkey", true);
