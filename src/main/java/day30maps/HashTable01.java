...
public class HashTable01 {
    ...
    public static void main(String[] args) {
        ...
        // Example 1: Store student names together with their email addresses, ages, grades, nationality
        //            Tom Hanks = th@gmail.com, 21, 2, American
        Hashtable<String, Students> studentsInfo = new Hashtable<String, Students>();
