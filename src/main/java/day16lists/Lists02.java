...
public class Lists02 {
    public static void main(String[] args) {
        //Example 1: Type code to remove the first occurence of a specific element from a String list
        ...
        //Example 2: Type code to remove all occurences of a specific element from a String list
        //           ["Shoes", "TV", "Radio", "Laptop", "Shoes", "Book", "Shoes"]
        ...
        //Example 5: Create an Integer List, then remove the first occurence of 4
        ...
        //      "valueOf()" method changes the data type without changing value
