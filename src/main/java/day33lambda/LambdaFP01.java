...
public class LambdaFP01 {
    ...
    public static void main(String[] args) {
        ...
        removeIfStartsWithAAndEndsWithO01(l);
        removeIfStartsWithAAndEndsWithO02(l);
    ...
    // 5) Create a method sort the elements according to their lengths then according to their first character
    ...
    public static void removeIfStartsWithAAndEndsWithO01(List<String> list){
    ...
    public static void removeIfStartsWithAAndEndsWithO02(List<String> list){
