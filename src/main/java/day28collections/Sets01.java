...
public class Sets01 {
    /*
            ...
            2) Sets are for storing unique data like email address, SSN, Phone Numbers in a Country...
            3) There are 3 different Sets:  i) HashSet: Uses "Hashing Technique".
                                            ...
                                            ii) LinkedHashSet: Puts the element in "Insertion Order"
    ...
    public static void main(String[] args) {
        ...
        nums2.add(41);
        nums2.add(-5);
        System.out.println(nums2);// [17, 67, -5, 5, 41]
        ...
        3)HashSets are the fastest among Sets. The order in which the values are entered is not taken into account.
        4) HashSet can use "null" object as element. However, if you want to add multiple null values to a HashSet, there will be only one null value.
