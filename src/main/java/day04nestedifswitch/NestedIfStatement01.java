...
public class NestedIfStatement01 {
    public static void main(String[] args) {
        ...
        char pwdInitial = input.next().charAt(0);//charAt() method returns just a single character, data type in Java
        //for single characters is "char".Because of that I used char data type for the pwd container.
