...
public class E03 {
    ...
    /*  1) "FileNotFoundException" is related with the "Path of the file" and the "Existence of the file".
        ...
        6) When you use parent and child exception classes together in a try-catch, child classes must come first
        ...
        8) What is the difference between "throw" and "throws" keyword?
