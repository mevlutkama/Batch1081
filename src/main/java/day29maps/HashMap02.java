...
public class HashMap02 {
    ...
    /*
            ...
            6) Java makes every HashCode unique bur sometimes Java can create same HashCode accidentally, this is called "HashCode Collision"
    ...
    public static void main(String[] args) {
        HashMap<String, Double> coursePrice = new HashMap<>();
        coursePrice.put("Full Stack Java Development", 6000.00);
        coursePrice.put("Full Stack Automation Engineer", 5800.00);
        coursePrice.put("SalesForce Development", 4500.00);
    }
}
