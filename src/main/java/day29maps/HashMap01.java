...
public class HashMap01 {
    ...
    /*
            ...
            6) HashMap's put the entries in random order, because of that it is super-fast
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stdAges);// {null=23, Tom Hanks=56, Brad Pit=55, Cuneyt Arkin=44, Angelina Julie=23, Ajda Pekkan=null, Ali Can=13}

        stdAges.remove("Ajda Pekkan", null);
        System.out.println(stdAges);// {null=23, Tom Hanks=56, Brad Pit=55, Cuneyt Arkin=44, Angelina Julie=23, Ali Can=13}
