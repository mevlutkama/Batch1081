...
public class CarRunner {
    ...
    public static void main(String[] args) {
        ...
        /*1)When you try to access a "variable" by using an object in inheritance, start to look for the "variable" in the class used
        in the "data type of the object"
          2)When you try to access a "method" by using an object in inheritance, start to look for the "object" in the class whose
        "constructor" was used
          3)In the first line of every constructor there is invisible "super()" to call default constructor from the parent class, if
        you want you type it explicitly.
